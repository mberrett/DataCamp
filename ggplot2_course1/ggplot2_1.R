...
ggplot(mtcars, aes(x = cyl, y = mpg)) + #not satisfying, cyl percieved as continuous var
  geom_point()

#================================================================================
# 2) Exploring ggplot2, part 2

# Load the ggplot2 package
library(ggplot2)

# Change the command below so that cyl is treated as factor
ggplot(mtcars, aes(x = factor(cyl), y = mpg)) + # turn cyl into a factor
  geom_point()

#================================================================================
# Video: Grammar of Graphics

# Data = the dataset being plotted
# Aesthetics = the scale onto which we map our data
# Geometries = the visual elements of our data
...
# Aesthetics = y-axis   color   size      alpha     line width
#              x-axis   fill    labels    shape     line type
...
#================================================================================
# 5) Understanding the grammar part 1
